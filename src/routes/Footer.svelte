<footer class="bg-gold-50" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    ...
    <div class="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; 2024 Caribbean Christian Centre for the Deaf. All rights reserved.<br />CCCD is a 501(c)3 nonprofit organization. Your contribution is tax-deductible to the extent allowed by law.
